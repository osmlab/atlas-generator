 ...
 * @author matthieun
 */
public class ChangedMultipleAtlasDeltaOutputFormat extends MultipleAtlasDeltaOutputFormat
{
    @Override
    ...
    {
        return new ChangedAtlasDeltaOutputFormat().getRecordWriter(fileSystem, job, name, progress);
    }
}
